...
!function ($) {
    ...
    BootstrapTable.prototype.initServer = function (silent, query) {
		...
		//add method
		if(this.options.ncmethod){
			params.method = this.options.ncmethod;
		}
	...
	BootstrapTable.prototype.hideColumns = function (params) {
        if (!params.hasOwnProperty('columns')) {
            return;
        }
		var that = this;
		$.each(params.columns, function(index, value){
			that.toggleColumn(getFieldIndex(that.options.columns, value), false, true);
		});
    };
