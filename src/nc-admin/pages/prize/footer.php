...
<script>
	...
	function updateform(type, data){
		if(type=="add"){
			...
			$form.find("#name").val('');
			$form.find("#name_in_sentence").val('');
			$form.find("#startdate").val('');
			$form.find("#enddate").val('');
			$form.find("#redemption_detail").val('');
			$form.find("#tnc").val('');
      $form.find("#multiplier").val('');
      $form.find("#numberofplay").val('');
      ...
      $form.find("#shortname").val(data.shortname);
      $form.find("#name_in_sentence").val(data.ashortname);
      $form.find("#redemption_detail").val(data.content);
      $form.find("#tnc").val(data.tnc);
      $form.find("#startdate").val(data.startdatetime);
      $form.find("#enddate").val(data.enddatetime);
      $form.find("#multiplier").val(data.multiplier);
      $form.find("#numberofplay").val(data.numberofplay);
