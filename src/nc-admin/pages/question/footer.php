...
<script>
	...
	function updateform(type, data){
      ...
      $form.find("#hints").val(data.hints);
      $form.find("#image").val(data.image);
		...
		*/
		...
		$table.bootstrapTable({
            ...
            columns:  [{
				...
				align:'center',
				formatter:function(value, row, index){
					return "<img src='<?=SERVER_PATH?>images/icons/"+value+"' width='100' height='100'>";
				}
			}, {
				field: 'name',
				title: 'Answer',
				...
				sortable:true
                        ...
                        formatter: function(value, row, index){
							return createActionButton(["edit","delete"]);
						}
                    }
			],
            url:"<?=$jsonGetURL?>",
