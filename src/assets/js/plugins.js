            ...
            return this.each(function() {
                ...
                */
                ...
                function loadInline(){
                    ...
                    content.find(".vb-close").click(function(e){
                        e.preventDefault();
                        closeVbox();
                    });
                    updateoverlay();
                ...
                function updateoverlay(){
                    ...
                    if(content.find(".message-content").length){
                        frameheight = content.find(".message-content").outerHeight();
                    }
